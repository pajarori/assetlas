...
| Bugcrowd | 217 | [`results/platforms/bugcrowd.json`](results/platforms/bugcrowd.json) |
...
| HackenProof | 0 | [`results/platforms/hackenproof.json`](results/platforms/hackenproof.json) |
| **Total** | **860** | |
