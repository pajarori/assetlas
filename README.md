...
|----------|---------:|------|
| HackerOne | 459 | [`results/platforms/hackerone.json`](results/platforms/hackerone.json) |
...
| HackenProof | 308 | [`results/platforms/hackenproof.json`](results/platforms/hackenproof.json) |
| **Total** | **1189** | |
